...
},{}],"js/btn-order.js":[function(require,module,exports) {
"use strict";
...
window.addEventListener("click", e => {
  ...
  (0, _scroll.default)(_refs.default.form);
});
},{"./common/refs":"js/common/refs.js","./common/scroll":"js/common/scroll.js"}],"js/gallery.js":[function(require,module,exports) {
"use strict";

var _refs = _interopRequireDefault(require("./common/refs"));

var _galleryPhoto = require("./data/gallery-photo");
...
const swiper = new _swiper.default(".swiper", {
  pagination: {
    el: ".swiper-pagination",
    clickable: true
  },
...
_refs.default.input_name.addEventListener("focus", onFocusInputName);

_refs.default.input_name.addEventListener("blur", onNotFocusInputName);

_refs.default.input_tel.addEventListener("focus", onFocusInputTel);

_refs.default.input_tel.addEventListener("blur", onNotFocusInputTel);

function onFocusInputName() {
  _refs.default.label_name.classList.add("visually-hidden");
}

function onNotFocusInputName(e) {
  if (e.target.value === "") {
    _refs.default.label_name.classList.remove("visually-hidden");
  } else return;
}

function onFocusInputTel() {
  _refs.default.label_tel.classList.add("visually-hidden");
}

function onNotFocusInputTel(e) {
  if (e.target.value === "") {
    _refs.default.label_tel.classList.remove("visually-hidden");
  } else return;
}
...
exports.removeErrorInputTel = removeErrorInputTel;
exports.removeErrorInputTelIsEmpty = removeErrorInputTelIsEmpty;
...
exports.showErrorInputTelIsEmpty = showErrorInputTelIsEmpty;
exports.showErrorInputTelIsWord = showErrorInputTelIsWord;
...
function showErrorInputNameIsNumber() {
  _refs.default.name_box_message.classList.remove("visually-hidden");

  _refs.default.name_message.textContent = "Поле Ім'я може містити тільки букви.";
}

function showErrorInputNameLength() {
  _refs.default.name_box_message.classList.remove("visually-hidden");

  _refs.default.name_message.textContent = "Поле Ім'я може містити 2 або більше символів.";
}

function showErrorInputTelIsWord() {
  _refs.default.tel_box_message.classList.remove("visually-hidden");

  _refs.default.tel_message.textContent = "Поле Телефон може містити тільки цифри.";
}

function showErrorInputNameIsEmpty() {
  _refs.default.name_box_message.classList.remove("visually-hidden");

  _refs.default.name_message.textContent = "Заповніть це поле.";

  _refs.default.submit_btn.setAttribute("disabled", "true");
}

function showErrorInputTelIsEmpty() {
  _refs.default.tel_box_message.classList.remove("visually-hidden");

  _refs.default.tel_message.textContent = "Заповніть це поле.";

  _refs.default.submit_btn.setAttribute("disabled", "true");
}

function removeErrorInputName() {
  _refs.default.name_box_message.classList.add("visually-hidden");
}

function removeErrorInputTel() {
  _refs.default.tel_box_message.classList.add("visually-hidden");
}

function showSubmitFormSuccess() {
  _refs.default.submit_message_success.classList.add("is-show");

  setTimeout(() => {
    _refs.default.submit_message_success.classList.remove("is-show");
  }, 5000);
}

function showSubmitFormError() {
  _refs.default.submit_message_error.classList.add("is-show");

  setTimeout(() => {
    _refs.default.submit_message_error.classList.remove("is-show");
  }, 5000);
}
...
function removeErrorInputNameIsEmpty() {
  setTimeout(() => {
    ...
    _refs.default.submit_btn.removeAttribute("disabled");
  }, 3000);
}
...
_refs.default.input_name.addEventListener("input", onCheckInputName);

_refs.default.input_tel.addEventListener("input", onCheckInputTel);
...
function onCheckInputTel(e) {
  ...
  if (/[а-яА-ЯёЁЇїІіЄєҐґa-zA-Z]/g.test(input_tel.value)) {
    (0, _formMessages.showErrorInputTelIsWord)();
    input_tel.classList.remove("success");
    input_tel.classList.add("error");
  } else {
    (0, _formMessages.removeErrorInputTel)();
    input_tel.classList.add("error");
  }

  if (/^((0|\+3|\+38|38))?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$/g.test(input_tel.value)) {
...
function checkInputAtError() {
  if (_refs.default.input_name.classList.contains("error") || _refs.default.input_tel.classList.contains("error")) {
    _refs.default.submit_btn.setAttribute("disabled", "true");
  } else _refs.default.submit_btn.removeAttribute("disabled");
}
...
function onSubmitForm(e) {
  ...
  if (tel.value === "") {
    (0, _formMessages.showErrorInputTelIsEmpty)();
    (0, _formMessages.removeErrorInputTelIsEmpty)();
    return;
  }
...
function fethTelegram(data) {
  ...
  fetch(URL_API, options).then(res => res.json()).then(res => {
...
require("./js/data/gallery-photo");

require("./js/common/refs");

require("./js/common/scroll");

require("./js/btn-order");
